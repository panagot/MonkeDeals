...
import { Box, Flex, Heading, Link, Spacer, IconButton, useColorModeValue, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody, VStack, Menu, MenuButton, MenuList, MenuItem, Avatar, Image, HStack, Alert, AlertIcon } from '@chakra-ui/react';
...
const navLinks = [
  { to: '/', label: 'Home' },
  { to: '/mint', label: 'Create Deal' },
  { to: '/marketplace', label: 'Discover Deals' },
  { to: '/portfolio', label: 'Portfolio' },
  { to: '/auctions', label: 'Auctions' },
  { to: '/group-deals', label: 'Group Deals' },
  { to: '/reputation', label: 'Reputation' },
  { to: '/smart-contract', label: 'Smart Contract' },
